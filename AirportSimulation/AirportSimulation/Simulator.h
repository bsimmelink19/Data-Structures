...
public:
	...
	void show_stats()
	{
		...
		double average_landing_wait = landing_queue->get_total_wait() / landing_queue->get_num_served();
		std::cout << "Average wait time in the arrival queue: " << average_landing_wait << std::endl;
		...
		double average_departure_wait = departure_queue->get_total_wait() / departure_queue->get_num_served();
		std::cout << "Average wait time in departure queue: " << average_departure_wait << std::endl;
		std::cout << std::endl;
	}
